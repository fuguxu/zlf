...
// var DEFAULT_URL = 'src/PDFShow/generic/web/compressed.tracemonkey-pldi-09.pdf';
...
var DISABLE_AUTO_FETCH_LOADING_BAR_TIMEOUT = 5000;
  ...
  // PDFJS.workerSrc = 'src/PDFShow/generic/pdf/pdf.worker.js';//开发环境跟测试环境的地址不同
  PDFJS.cMapUrl = './cmaps/';
...
(function mozPrintCallbackPolyfillClosure() {
  ...
  function renderProgress() {
    ...
    if (canvases) {
      ...
      parent.Bus.$emit('sendPdfViewerData',true);//向父页面传递 其他的可以显示了
      progressContainer.setAttribute('hidden', '');//这个时候 打印的进度条影藏起来了
    }
  }
...
var SecondaryToolbar = {
  ...
  open: function secondaryToolbarOpen() {
    ...
    parent.Bus.$emit('sendPdfViewerDocListsData',false);//向父页面传递 隐藏文件列表
  },
  ...
  close: function secondaryToolbarClose(target) {
    ...
    this.toggleButton.classList.remove('toggled');
      parent.Bus.$emit('sendPdfViewerDocListsData',true);//向父页面传递 隐藏文件列表
  },
...
function webViewerInitialized() {
  ...
  //同步系统的多语言
    var parentLang=new parent.Vue().$lang;
    switch (parentLang){
        case 'zh-cn':parentLang='zh-CN';break
        case 'en':parentLang='en-US';break
        case 'ja':parentLang='ja';break
    }
    PDFJS.locale=parentLang;
